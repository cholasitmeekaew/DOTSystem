...
insert into revenue_sharing_config (scope, officer_share_percent, central_share_percent, notes) values
  ('default', 20.00, 80.00, 'เคสบริการทั่วไป: 20% เจ้าหน้าที่รับเคส, 80% กองกลาง'),
  ('vehicle_rescue', 10.00, 90.00, 'หน่วยกู้ภัยรถยก: 10% เจ้าหน้าที่รับเคส, 90% กองหน่วย')
