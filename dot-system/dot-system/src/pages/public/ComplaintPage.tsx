...
export function ComplaintPage() {
  ...
  if (status === 'success') {
    return (
      <FadeIn className="max-w-2xl mx-auto px-6 py-20 text-center">
        <div className="inline-flex w-20 h-20 bg-emerald-500/10 border-2 border-emerald-500/30 rounded-full items-center justify-center mx-auto mb-6 anim-scaleIn">
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-12">
      ...
      <Stagger className="space-y-5">
        ...
        <StaggerItem>
          <div className="flex items-start gap-3 bg-blue-900/20 border border-blue-900/40 rounded-xl p-4 hover-lift">
        ...
        <StaggerItem>
          <button
            ...
            className="btn-primary w-full py-3.5 flex items-center justify-center gap-2 text-base mt-2 btn-ripple"
          >
            <Send size={17} />
