...
export function ManualPage({ onBack, showBackButton = true }: Props) {
  const [activeId, setActiveId] = useState<string>(manualChapters[0]?.sections[0]?.id ?? '');
            ...
            <header className="manual-cover">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">คู่มือระเบียบการปฏิบัติราชการ · DOT System</p>
                </div>
              </div>
            </header>
